...
- [Sprint 13 — Measurable Early-Warning Benchmark](sprint-plans/sprint-13.md) — **Active (Batches A/B/C1/C2/D1/D2 accepted, `MEASURABLE` accepted; Task 16 accepted — ledger PASS; Task 17 deep review not started; Sprint 14 not started). Goal: prove that event ranking, positive lead time, false alerts, and later risk evaluation are structurally measurable under a frozen independent protocol.**
...
| 19 | Measurable multi-category early-warning benchmark with independent event controls | Active — Sprint 13 (all batches accepted, `MEASURABLE` accepted; Task 16 accepted; Task 17 not started) |

...
- [Sprint 13 — Measurable Early-Warning Benchmark](sprint-plans/sprint-13.md) — **Active (Batches A/B/C1 accepted, v4 approved; Task 11 materialization done — 13/13 histories, review pending; Batch D not started). Goal: prove that event ranking, positive lead time, false alerts, and later risk evaluation are structurally measurable under a frozen independent protocol.**
...
| 19 | Measurable multi-category early-warning benchmark with independent event controls | Active — Sprint 13 (A/B/C1 accepted; Task 11 done, review pending; Batch D not started) |

...
- [Sprint 11 — Chronological Factory Geometry and Early-Warning Validation](sprint-plans/sprint-11.md) — **Active; all Tasks 1–37 implemented/completed for review, all batch evidence gates pass, pending the sprint-wide deep-review gate**
## Paused Sprints

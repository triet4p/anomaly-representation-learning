...
**Status:** Active — REMEDIATION (Batches A–D + Task 16 final-accepted; combined D2-v411/Task16 review PASS; Task 17 ready for fresh differential deep review; verdict `NOT_MEASURABLE`; Sprint 14 BLOCKED).

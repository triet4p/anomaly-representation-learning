...
**Status:** Active — REMEDIATION (B/C1 renewed-accepted under v4.1; Task 16 ledger corrected for 3 findings, review pending; Task 17 pending fresh deep review; Sprint 14 BLOCKED).

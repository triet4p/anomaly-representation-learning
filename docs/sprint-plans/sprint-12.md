...
### Batch D — Bounded representation experiment (corrected rerun complete; awaiting fresh review)
...
- Batch B: ACCEPTED PASS with zero actionable defects (review artifacts/sprint-12/review-B.md → review-B2.md by Sprint12EvidenceB2; standard AUROC, frozen dev-train standardization, calibrated null, conditional S2/S3; handcrafted 0.663 treated as modest diagnostic only).
...
- Batch D: awaiting fresh review (corrected ablation at 4b4eef8: positional mean + fixed unit variance; G-learn FAIL valid — ranking 0.59, spearman 0.28, nuisance 0.35, bg 0.02 pass; revised worst in matched comparison; old D run superseded as defective with narrative corrected; Task 10 blocked; no Task 10/11 work; worker does not self-accept).

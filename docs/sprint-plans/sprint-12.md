...
- Batch C: Task 5 DONE (protocol v1 frozen); Task 6 BLOCKED (structural dev-cohort emptiness at v1 scale; v2 proposal in task-6.md awaits explicit approval; worker does not self-accept).
- Batch D: pending.

...
- Batch D: awaiting review (G-learn FAIL: ranking 0.59/0.80, spearman 0.29/0.50, bg 0.15/0.10, nuisance 0.22/0.10; one bounded correction consumed without material change; matched comparison hidden 0.59 < frozen 0.71 < handcrafted 0.95 ranking; NOTHING selected; Task 10 blocked without sealed tuning; worker does not self-accept).

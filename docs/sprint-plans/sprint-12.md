...
- Batch F: awaiting review (Task 11: no precursor elevation, degenerate stratification by construction; Task 12: G-rank FAIL median 0.553; Task 13 BLOCKED unfitted; worker does not self-accept).
- Batch G: pending.

...
### Batch C — Independent development and evaluation protocol (v2 complete; awaiting review)
...
- Batch C: awaiting review (v2: 8 base-physics histories, aggregate CAL 51 / FIT 200, per-history sealed floors met, 4 PASS-gated seals, v1 roots retired VOID; inverse wear scaling rejected; worker does not self-accept).
- Batch D: pending.

# Sprint 15 Observable Probe v2 — Frozen Pre-Outcome Specification (candidate 2)
...
**Probe identifier:** `sprint15-observable-probe-v2`.
**Code:** `src/synth/probe15.py` (SHA256
`a08b3d5fb83001e1f5c43f4c56ff536bae85e41d494db289304aeb33a339242b`).
...
**Candidate binding:** candidate 2 (`sprint15-benchmark-protocol-v2`, Fit H-FIT-13..15,
Calibration H-CAL-5, Confirmation H-CONF-14..17 — none materialized yet).
...
for Fit seeds 1104–1106 (`H-FIT-13..15`), Calibration seed 1107 (`H-CAL-5`), Confirmation seeds
1108–1111 (`H-CONF-14..17`) — each exactly once, first-attempt, after Gate C2 PASS. Sealed seeds
1112–1115 receive structural audit and seals only; no probe, score, or threshold may touch them.
Fitting uses Fit only, threshold uses Calibration healthy only, evaluation runs once on all four
Confirmation histories via `probe15.evaluate_histories`.

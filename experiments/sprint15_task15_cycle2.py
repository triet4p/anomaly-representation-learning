"""Sprint 15 Task 15 cycle-2: one-shot frozen-probe execution (candidate 2).
...
``artifacts/sprint-15/observable-confirmation-cycle-2.json`` and prints a
summary (recorded in ``artifacts/sprint-15/task-15-cycle-2.md``).
...
FIT = (("H-FIT-13", 1104), ("H-FIT-14", 1105), ("H-FIT-15", 1106))
CAL = ("H-CAL-5", 1107)
CONF = (("H-CONF-14", 1108), ("H-CONF-15", 1109), ("H-CONF-16", 1110),
        ("H-CONF-17", 1111))
BASE = Path("data/generated/sprint15-v2")
OUT = Path("artifacts/sprint-15/observable-confirmation-cycle-2.json")

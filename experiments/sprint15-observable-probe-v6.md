# Sprint 15 Observable Probe v6 — Frozen Pre-Outcome Specification (candidate 6)
...
**Probe identifier:** `sprint15-observable-probe-v6`.
**Code:** `src/synth/probe15.py` (SHA256
`a08b3d5fb83001e1f5c43f4c56ff536bae85e41d494db289304aeb33a339242b`) — behavior identical to
the reviewed v4 freeze; no feature, scoring, threshold, or metric line changed for candidate 6.
...
re-executed 2026-09-10 in Task 13 cycle-6).
**Candidate binding:** candidate 6 (`sprint15-benchmark-protocol-v6`, Fit H-FIT-25..27,
Calibration H-CAL-9, Confirmation H-CONF-30..33 — none materialized yet).
...
for Fit seeds 1504–1506 (`H-FIT-25..27`), Calibration seed 1507 (`H-CAL-9`), Confirmation seeds
1508–1511 (`H-CONF-30..33`) — each exactly once, first-attempt, after Gate C2 cycle-6 PASS. Sealed
seeds 1512–1515 receive structural audit and seals only; no probe, score, or threshold may touch

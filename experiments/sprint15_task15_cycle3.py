"""Sprint 15 Task 15 cycle-3: one-shot frozen-probe execution (candidate 3).
...
``artifacts/sprint-15/observable-confirmation-cycle-3.json`` and prints a
summary (recorded in ``artifacts/sprint-15/task-15-cycle-3.md``).
...
FIT = (("H-FIT-16", 1204), ("H-FIT-17", 1205), ("H-FIT-18", 1206))
CAL = ("H-CAL-6", 1207)
CONF = (("H-CONF-18", 1208), ("H-CONF-19", 1209), ("H-CONF-20", 1210),
        ("H-CONF-21", 1211))
BASE = Path("data/generated/sprint15-v3")
OUT = Path("artifacts/sprint-15/observable-confirmation-cycle-3.json")
...
def main() -> int:
    ...
    for role, seed in FIT:
        ...
        assert manifest.get("protocol") == B.S15_PROTOCOL_V3, f"tag:{role}"
    ...
    record = {
        ...
        "eg4_satisfiable": len(evaluated) == 4,
        "metrics": result,
    }

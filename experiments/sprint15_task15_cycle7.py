"""Sprint 15 Task 15 cycle-7: one-shot frozen-probe execution (candidate 7).
...
``artifacts/sprint-15/observable-confirmation-cycle-7.json`` and prints a
summary (recorded in ``artifacts/sprint-15/task-15-cycle-7.md``).
...
OUT = Path("artifacts/sprint-15/observable-confirmation-cycle-7.json")

# Sprint 15 Observable Probe v3 — Frozen Pre-Outcome Specification (candidate 3)
...
**Probe identifier:** `sprint15-observable-probe-v3`.
**Code:** `src/synth/probe15.py` (SHA256
`a08b3d5fb83001e1f5c43f4c56ff536bae85e41d494db289304aeb33a339242b`) — behavior identical to
the reviewed v2 freeze; no feature, scoring, threshold, or metric line changed for candidate 3.
...
**Candidate binding:** candidate 3 (`sprint15-benchmark-protocol-v3`, Fit H-FIT-16..18,
Calibration H-CAL-6, Confirmation H-CONF-18..21 — none materialized yet).
...
for Fit seeds 1204–1206 (`H-FIT-16..18`), Calibration seed 1207 (`H-CAL-6`), Confirmation seeds
1208–1211 (`H-CONF-18..21`) — each exactly once, first-attempt, after Gate C2 cycle-3 PASS. Sealed
seeds 1212–1215 receive structural audit and seals only; no probe, score, or threshold may touch

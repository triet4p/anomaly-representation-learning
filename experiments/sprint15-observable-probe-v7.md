# Sprint 15 Observable Probe v7 — Frozen Pre-Outcome Specification (candidate 7)
...
**Probe identifier:** `sprint15-observable-probe-v7`.
**Code:** `src/synth/probe15.py` (SHA256
`a08b3d5fb83001e1f5c43f4c56ff536bae85e41d494db289304aeb33a339242b`) — behavior identical to
the reviewed v6 freeze; no feature, scoring, threshold, or metric line changed for candidate 7.
...
re-executed 2026-09-10 in Task 13 cycle-7).
**Candidate binding:** candidate 7 (`sprint15-benchmark-protocol-v7`, Fit H-FIT-28..30,
Calibration H-CAL-10, Confirmation H-CONF-34..37 — none materialized yet).
...
for Fit seeds 1604–1606 (`H-FIT-28..30`), Calibration seed 1607 (`H-CAL-10`), Confirmation seeds
1608–1611 (`H-CONF-34..37`) — each exactly once, first-attempt, after Gate C2 cycle-7 PASS. Sealed
seeds 1612–1615 receive structural audit and seals only; no probe, score, or threshold may touch
